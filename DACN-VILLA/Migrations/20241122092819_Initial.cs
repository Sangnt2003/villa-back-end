        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<int>(type: "int", nullable: false),
                    PreCmtId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VillaServices", x => new { x.VillaId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_VillaServices_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VillaServices_Villas_VillaId",
                        column: x => x.VillaId,
                        principalTable: "Villas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingProcesses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingProcesses_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingProcesses_UserId",
                table: "BookingProcesses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Villas_DiscountId",
                table: "Villas",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_Villas_LocationId",
                table: "Villas",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_VillaServices_ServiceId",
                table: "VillaServices",
                column: "ServiceId");
        }
